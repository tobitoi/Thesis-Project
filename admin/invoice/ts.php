...
$query="SELECT container.*,masterkontainer.tipe,masterkontainer.size,masterkontainer.idAgen,agen.namaAgen,kapal.Nama,masteralat.namaAlat,masteralat.statusa
 ...
 where  container.idkontainer=masterkontainer.idkontainer AND container.status='$status'  AND masterkontainer.idAgen = agen.idAgen AND container.idKapal=kapal.idKapal
