...
function combo_agen($kode) {
	echo "<option value='' selected>- Pilih Agen -</option>";
	$query = query("SELECT *  FROM agen");
...
function combo_tipe($kode) {
	echo "<option value='' selected>- Pilih tipe -</option>";
	$query = query("SELECT tipe  FROM masterkontainer ");
	while ($row = mysql_fetch_row($query)) {
		if ($kode == "")
			echo "<option value='$row[0]'> " . ucwords($row[0]) . " </option>";
		else
...
function combo_kontainer($kode) {
	echo "<option value='' selected>- Pilih kontainer -</option>";
	$query = query("SELECT * FROM masterkontainer ");
	while ($row = mysql_fetch_row($query)) {
		if ($kode == "")
			echo "<option value='$row[0]'> " . ucwords($row[0]) . " </option>";
		else
...
function combo_kapal($kode) {
	echo "<option value='' selected>- Pilih Kapal -</option>";
	$query = query("SELECT * FROM kapal ");
	while ($row = mysql_fetch_row($query)) {
		if ($kode == "")
			echo "<option value='$row[0]'> " . ucwords($row[0]) . " </option>";
		else
...
function combo_alat($kode) {
	echo "<option value='' selected>- Pilih alat-</option>";
	$query = query("SELECT * FROM masteralat ");
	while ($row = mysql_fetch_row($query)) {
		if ($kode == "")
			echo "<option value='$row[0]'> " . ucwords($row[0]) . " </option>";
		else
...
function list_links() {
	...
	$query = query("SELECT MAX(tanggal),idkontainer FROM status ");
	while ($row = mysql_fetch_row($query)) {
		echo "<li><a href='.$row[0].' ></i>" . ucwords($row[0]) . "</a> </li>";

	}
}
function list_links1() {

	$query = query("SELECT MAX(idkontainer) FROM status ");
	while ($row = mysql_fetch_row($query)) {
		echo "<li><a href='.$row[0].' ></i>" . ucwords($row[0]) . "</a> </li>";
